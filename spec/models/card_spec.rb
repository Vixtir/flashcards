...
describe "sort method" do
 let(:card1) { FactoryGirl.create(:card, original_text: "Yellow",
                                         translated_text: "Желтый") }
 let(:card2) { FactoryGirl.create(:card, original_text: "Red",
                                         translated_text: "Красный") }
